      ...
      <div className='col-lg-4 d-flex justify-content-center align-items-center flex-column '>
        <div className='border shadow p-5'>
          <h2 className='text-danger'>Cart Summary</h2>
            <h4>Total Number of Products : <span className='text-primary fw-bolder fw-2'>{cartArray.length}</span></h4>
            <h4>Total Price : <span className='text-secondary fw-bolder fs-3 ms-3'>₹ {total}</span></h4>
